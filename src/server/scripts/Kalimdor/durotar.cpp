...
class npc_tiger_matriarch : public CreatureScript
{
    public:
        ...
        {
            npc_tiger_matriarchAI(Creature* pCreature): ScriptedAI(pCreature),
                _tiger(NULL) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return new npc_tiger_matriarchAI(pCreature);
        }
};
...
class npc_troll_volunteer : public CreatureScript
{
    public:
        ...
        {
            npc_troll_volunteerAI(Creature* pCreature): ScriptedAI(pCreature)
            {
                Reset();
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return new npc_troll_volunteerAI(pCreature);
        }
};
