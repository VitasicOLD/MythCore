...
public:
    ...
    struct boss_deathbringer_saurfangAI : public BossAI
    {
        ...
        void JustDied(Unit* pKiller)
        {
            ...
            if(GameObject* loot = pKiller->SummonGameObject(RAID_MODE(GO_DEATHBRINGER_S_CACHE_10N, GO_DEATHBRINGER_S_CACHE_25N, GO_DEATHBRINGER_S_CACHE_10H, GO_DEATHBRINGER_S_CACHE_25H), -494.7f,  2173.7f, 539.2f, 0, 2.75f, 2.75f, 2.75f, 2.75f, 100000))
            {
                loot->SetLootRecipient(me->GetLootRecipient());
