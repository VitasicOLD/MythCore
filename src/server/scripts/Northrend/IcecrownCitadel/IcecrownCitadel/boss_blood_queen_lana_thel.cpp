    ...
    public:
        ...
        class spell_blood_queen_vampiric_bite_SpellScript : public SpellScript
        {
            ...
            void OnCast()
            {
                ...
                if(GetCaster()->ToPlayer()->GetQuestStatus(QUEST_BLOOD_INFUSION) == QUEST_STATUS_INCOMPLETE && (GetCaster()->ToPlayer()->GetDifficulty(true) == RAID_DIFFICULTY_25MAN_NORMAL || GetCaster()->ToPlayer()->GetDifficulty(true) == RAID_DIFFICULTY_25MAN_HEROIC))
                {
